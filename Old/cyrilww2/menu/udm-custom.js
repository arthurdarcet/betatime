...
um.baseSRC = "templates/cyrilww2/images/";
...
um.navbar = [
	...
	"163px",	// width ["em"|"ex"|"px"] (vertical navbar only - horizontal navbar items have "auto" width) ("%" doesn't work right) 
	];
...
um.items = [
	...
	"black",// border colors ["color"|"#hex"|"rgb()"] (single, double or four values)
	"solid",	// border styles ["solid"|"double"|"dotted"|"dashed"|"groove"|"ridge"|"inset"|"outset"] (single, double or four values; be careful with using "none")
	"black",// hover/focus border colors ["color"|"#hex"|"rgb()"] (single, double or four values)
	"solid",	// hover/focus border styles ["solid"|"double"|"dotted"|"dashed"|"groove"|"ridge"|"inset"|"outset"] (single, double or four values; be careful with using "none")
	"black",// visited border colors ["color"|"#hex"|"rgb()"] (single, double or four values)
	...
	"#95c9ef",		// background ["color"|"#hex"|"rgb()"|"image.gif"]
	"#16548f",		// hover/focus background ["color"|"#hex"|"rgb()"|"image.gif"]
	"#95c9ef",		// visited background ["color"|"#hex"|"rgb()"|"image.gif"]
	...
	"droite.gif",// menu indicator character/image ["text"|"image.gif"|"none"] 
	"droite_over.gif",// menu indicator rollover character/image ["text"|"image.gif"|"none"] (must be same type)
...
um.menuItems = [
	...
	"#95c9ef",	// border colors ["color"|"#hex"|"rgb()"] (single, double or four values)
	"solid",	// border styles ["solid"|"double"|"dotted"|"dashed"|"groove"|"ridge"|"inset"|"outset"] (single, double or four values; be careful with using "none")
	"#16548f",		// hover/focus border colors ["color"|"#hex"|"rgb()"] (single, double or four values)
	"solid",	// hover/focus border styles ["solid"|"double"|"dotted"|"dashed"|"groove"|"ridge"|"inset"|"outset"] (single, double or four values; be careful with using "none")
	...
	"",		// additional hover/focus CSS (careful!)
	"",		// additional visited CSS (careful!)
	"droite_petit.gif",// submenu indicator character/image ["text"|"image.gif"|"none"] 
	"droite_petit.gif",// submenu indicator rollover character/image ["text"|"image.gif"|"none"] (must be the same type)
