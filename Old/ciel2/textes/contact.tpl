...
<table>
	<form action="?page=contact&nbr1={NBR1}&nbr2={NBR2}" method="post">
		<tr>
		...
		<tr>
		  <td colspan="4" align="center">Anti-spam : Quel est le resultat de l'op&eacute;ration suivante : <br />
		    {NBR1} x {NBR2} = 
              <input name="anti-spam" type="text" size="5" maxlength="2" /></td>
	  </tr>
		<tr>
