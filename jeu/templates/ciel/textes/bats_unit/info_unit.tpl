...
<!-- BEGIN achat -->
  ...
  <form action="#" method="post">
  	<p>- Vendre <input name="nbr_unit_vendre" type="text" value="0" size="4" maxlength="5" /> 
  	{vente_unit.NOM}(s) à <img src="templates/ciel/images/ressources/beta.gif" alt="beta" title="Beta" /> {vente_unit.PRIX}({vente_unit.TAUX} du prix d'achat) l'unit&eacute;
	<input name="id_unit" value="{vente_unit.ID}" type="hidden" />
	<input value="Valider" type="submit" /></p>
  </form>
	<!-- END vente_unit -->
</div>