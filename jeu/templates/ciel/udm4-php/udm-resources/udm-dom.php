...
foreach($umary as $data)
{
	foreach($um[$data] as $subdata)
	{
		...
		if(eregi("(gif|png|mng|jpg|jpeg|jpe|bmp)",$subdata)) { $umimgs[$m++]=$subdata; }
	}
}
$umjs.="];";
...
$umjd[$j++]="um.ap=function(c,v){var r=um.rv.length;if(r>0){var i=0;do{if(um.rv[i][1]==''){um.rv[i][0](v,c);}else if(c==um.rv[i][1]){um.rv[i][0](v);}i++;}while(i<r);}};";
$umjd[$j++]="if(!um.k&&typeof window.addEventListener!=um.un){window.addEventListener('load',umIni,0);}else if(um.o7){um.m.addEventListener('load',umIni,0);}else if(um.wie){window.attachEvent('onload',umIni);um.eva=[];um.ex=['onmouseover','onmouseout','onmousedown','onmouseup','onclick','onmousewheel','onfilterchange','onkeydown','onfocus','onactivate','onscroll','over','out'];um.gg=um.ex.length;window.attachEvent('onunload',function(){um.lil=umTree.getElementsByTagName('li');um.lin=um.lil.length;i=0;do{um.gc(um.lil[i]).detachEvent((um.wie55)?'onactivate':'onfocus',um.eva[i]);i++;}while(i<um.lin);um.da=document.all.length;i=0;do{um.t=document.all[i];j=0;do{um.t[um.ex[j]]=null;j++;}while(j<um.gg);i++;}while(i<um.da);});}else{if(typeof window.onload=='function'){um.on=onload;window.onload=function(){um.on();umIni();};}else{window.onload=umIni;}}";
$umjd[$j++]="function umIni(g){if(typeof g==um.un){g=1;}if(typeof um.ini!=um.un||(um.k&&typeof window.sidebar==um.un)){return;}um.ini=1;um.ha=0;umTree=(um.b)?um.gd('udm'):null;if(umTree&&um.d){if(g){um.ap('000',umTree);}";
...
$umjd[$j++]="var l=umTree.getElementsByTagName('li');i=0;do{";
...
$umjd[$j++]="l.onmousedown=function(e){um.lf=1;um.ap('030',um.gc(this));(!e)?event.cancelBubble=1:e.stopPropagation();};l.onmouseup=function(e){um.ap('035',um.gc(this));(!e)?event.cancelBubble=1:e.stopPropagation();};if(h!='onclick'){l.onclick=function(e){if(!um.bub){um.qc(um.gc(this).href);}um.bub=1;};}else if(!um.mie){l.onmouseover=function(){um.n.lr(um.gc(l),1);um.bub=0;};}if(!(um.mie&&h=='onclick')){l[h]=function(e){var v=(um.ie)?window.event.srcElement:e.target;if(v.nodeName=='#text'&&e.type=='click'){v=v.parentNode;}if(!um.gp(v)){return false;}var b=um.es(um.gp(v).className);var c=(um.lf&&!um.nm&&b.indexOf('onclick')!=-1);if(c){um.rt=um.e[10];um.e[10]=1;}if(b.indexOf('onclick')==-1){um.bub=0;}else if(!um.lf){if(!um.bub){um.qc(v.href);}um.bub=1;}this.over(0,v);if(c){um.e[10]=um.rt;um.lf=0;if(v.nodeName!='#text'&&um.gu(um.gp(v)).length>0){if(typeof v.blur!=um.un){v.blur();}if(um.gu(um.gp(v))[0].style.display=='block'){um.n.cd(this.parentNode);(!e)?event.cancelBubble=1:e.stopPropagation();return false;}(!e)?event.cancelBubble=1:e.stopPropagation();b=um.es(um.gp(v).className);return (b.indexOf('(true)')!=-1);}else{um.qc(v.href);um.bub=1;}}if(!e){e=window.event;}return (e.type=='click'||um.o7||um.mx);};l.onmouseout=function(e){this.out(e);};}l.over=function(f,t){if(um.bub||(!f&&um.ha&&um.kdf)){return false;}var c=um.n.cck();if(!c||um.mf){um.mf=0;if(!um.ec){if(um.gm(this)){this.removeChild(um.gm(this));}}return false;}";
if($umkb) 
{
...
$umjd[$j++]="umNav.prototype.lr=function(l,v){if(l&&typeof l.style!=um.un&&!(um.p&&um.mx)){um.cl=um.es(l.className);um.ii=um.ne(um.gp(l));if(v){l.style.zIndex=um.e[6]+=2;(um.cl=='')?l.className='udmR':l.className+=(l.className.indexOf('udmR')==-1)?' udmR':'';}else{if(um.cl.indexOf('udmR')!=-1){l.className=um.cl.replace(/([ ]?udmR)/g,'');}}";
if($umaz) 
{
...
$umjd[$j++]="if(!um.nm&&m&&m.style.visibility!='visible'){if(um.wie){if(um.e[61]>0){um.gc(m).style.marginTop=um.e[61]+'px';}else if(um.e[63]=='collapse'){m.firstChild.style.marginTop=0+'px';}}";
if($umkb) 
{
...
$umjd[$j++]="umNav.prototype.ou=function(m,l){if(m==null){this.cd(l.parentNode);return false;}this.cd(um.gp(m).parentNode);if(typeof m.m==um.un){m.m=um.gu(m);m.l=m.m.length;if(m.l>0){for(var i=0;i<m.l;i++){um.xh(m.m[i]);um.xn(m.m[i]);}}}if(um.ep){m.style.position='static';}";
if($umhz) 
{
...
if($umaz) 
{
	$umjd[$j++]="if(!um.nr&&um.e[89]!='none'){var c=m.childNodes.length;i=0;do{var t=m.childNodes.item(i);var n=um.vn(t.nodeName).toLowerCase();if(n=='li'){var a=um.n.ga(um.gc(t));if(a){this.wp(a,t,um.e[70],um.e[62],0);}}i++;}while(i<c);}";
}
...
$umjd[$j++]="um.hf=(um.wie55&&typeof m.filters!='unknown'&&m.filters&&m.filters.length>0);if(um.hf){m.filters[0].Apply();}if(um.wie&&um.h){t=m.parentNode;if(um.ne(t)){t=t.style;t.position='absolute';t.zIndex=um.e[6]+=2;t.position='relative';}}um.xv(m);if(um.hf){um.ap('065',m);m.filters[0].Play();";
if($umds) 
{
...
$umjd[$j++]="if(um.wie50){um.xn(m);um.xd(m);}um.ap('060',m);return m;};";
$umjd[$j++]="umNav.prototype.cd=function(m){var s=(um.mie&&!um.mx)?um.gt(m,'ul'):um.gu(m);var n=s.length;i=-1;while(++i<n){this.clm(s[i]);}};";
$umjd[$j++]="umNav.prototype.ck=function(m){var l=(um.mie&&!um.mx)?um.gt(m,'a'):m.getElementsByTagName('a');var n=l.length;i=-1;while(++i<n){this.lr(l[i],0);}};";
...
$umjd[$j++]="um.t=['udmC','udmS'];i=0;do{if(um.wie55||i>0){var b=m.parentNode.lastChild;if(b.className){if(b.className.indexOf(um.t[i])!=-1){m.parentNode.removeChild(b);}}}i++;}while(i<2);}um.ap('070',m);}};";
if($umaz) 
{
	$umjd[$j++]="umNav.prototype.ga=function(l){var a=null;var t=['span','img'];var k=0;do{var s=l.getElementsByTagName(t[k]);var n=s.length;j=-1;while(++j<n){var b=um.es(s[j].className);if(b=='udmA'){a=s[j];break;}}}while(++k<2);return a;};";
...
$umjd[$j++]="umNav.prototype.wpo=function(a,l,p,b,n){var s=um.gc(l);var t=[a.offsetWidth,a.offsetHeight];a.style.marginTop=um.pi(((s.offsetHeight-t[1])/2)-b)+'px';s.style[(um.a||um.rtl)?'paddingLeft':'paddingRight']=((p*2)+t[0])+'px';if(um.wie&&um.rtl){a.style.marginRight=((n)?(0-um.e[26]):(0-um.e[70]))+'px';}if(((um.wie50&&um.a)||(um.wie55&&um.rtl))&&n&&um.h){a.style.top=(b)+'px';a.style.left=(b)+'px';}if((n&&um.ni)||(!n&&um.mi)){var c=((n)?um.e[47]:um.e[91]);if((t[0]-c)<0){c=t[0];}a.style.clip=(um.a||um.rtl)?'rect(0,'+c+'px,'+t[1]+'px,0)':'rect(0,'+t[0]+'px,'+t[1]+'px,'+(t[0]-c)+'px)';}um.xv(a);return true;};";
...
if($umds) 
{
	$umjd[$j++]="umNav.prototype.hl=function(m){var d={'class':'udmS'};um.sh=m.parentNode.appendChild(um.createElement('span',d));var c=um.es(m.className);if(c!=''){if(typeof um.v[c]!=um.un){if(um.sh.className.indexOf(c)==-1){um.sh.className+=' '+c;}}}um.sh.style.width=m.offsetWidth+'px';var h=m.offsetHeight;if(typeof um.scr!=um.un){h=scr.gmh(m);}um.sh.style.height=h+'px';var p={x:(m.offsetLeft),y:(m.offsetTop)};var s=um.ne(um.sh.parentNode);if(um.s&&!um.s1&&!s){p.x-=um.e[51];p.y-=um.e[51];}um.sh.style.left=p.x+'px';um.sh.style.top=p.y+'px';return um.sh;};";
}
if($umif) 
{
...
if($umhz) 
{
	$umjd[$j++]="umNav.prototype.ts=function(v){var s=um.m.getElementsByTagName('select');var n=s.length;if(n>0){i=0;do{s[i++].style.visibility=v;}while(i<n);um.ap((v=='hidden')?'067':'077',s);}};";
}
...
if($umrw) 
{
	$umjd[$j++]="if(um.rg){um.rw=0;var n=um.tr.childNodes;var l=n.length;i=0;do{if(n[i].nodeName!='#text'){this.dw(n[i]);}i++;}while(i<l);this.aw();}";
}
