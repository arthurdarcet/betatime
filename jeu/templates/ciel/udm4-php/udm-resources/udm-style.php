...
$config = $_SERVER['DOCUMENT_ROOT'] . '/jeu/templates/ciel/udm4-php/udm-resources/udm-custom.ini';
...
$umr[$j++]='.udm{'.(eregi('(gif|png|mng|jpg|jpeg|jpe|bmp)',$um['hstrip'][0])?'background-image:url('.$um['baseSRC'].$um['hstrip'][0].');':'background-image:none;background-color:'.$um['hstrip'][0].';').'float:'.$umhfl.';width:100%;}';
if($um['hstrip'][0]!='none')
{
...
$umr[$j++]=$um['t'][2].$um['t'][31].'{margin-'.$um['orientation'][2].':0;'.$um['orientation'][2].':'.$um['orientation'][5].';}}';
}
else
{
$umr[$j++]=$um['t'][2].'.udm{float:'.$umdir.';}}';
$umr[$j++]=$um['t'][2].$um['t'][31].'{float:none;}}';
...
$umr[$j++]=$um['t'][2].$um['t'][31].'>li:first-child{'.$um['t'][0].$um['orientation'][4].';}}';
$umr[$j++]='.udm li{left:'.$um['orientation'][4].';}';
$umr[$j++]=$um['t'][2].'.udm li{'.$um['t'][19].'}}';
$umr[$j++]='.udm ul li{left:0;}';
$umr[$j++]='ul[class^="udm"] li{left:0;'.$um['t'][16].'}';
$umr[$j++]=$um['t'][18].'ul[class^="udm"] li{left:'.$um['orientation'][4].';'.$um['t'][19].'}}';
$umr[$j++]=$um['t'][2].$um['t'][31].' li{'.$um['t'][16].'}}';
$umr[$j++]=$um['t'][18].'.udm/**/[class="udm"] ul li{'.$um['t'][19].'left:0;}}';
$umr[$j++]=$um['t'][2].'.udm ul li:not(:nth-child(n)){'.$um['t'][16].'}}';
...
$umr[$j++]=$um['t'][2].'.udm li a:not(:nth-child(n)){'.$um['t'][16].'float:'.$umdir.';}}';
if($umdra){$umr[$j++]=$um['t'][2].$um['t'][34].'{'.$um['t'][16].'}}';}
...
$umr[$j++]=$um['t'][2].$um['t'][31].' li:first-child{'.$um['t'][0].$um['orientation'][4].' !important;}}';
$umr[$j++]=$um['t'][2].$um['t'][31].' li:first-child a{'.$um['t'][0].'-'.$um['items'][1].'px;}}';
$umr[$j++]=$um['t'][2].$um['t'][31].' ul li:first-child{'.$um['t'][0].'0 !important;}}';
$umr[$j++]='head:first-child+body ul[class^="udm"] li:not(:first-child){'.$um['t'][0].'-'.$um['items'][1].'px;}';
$umr[$j++]='.udm ul li{'.$um['t'][0].'0 !important;}';
$umr[$j++]='ul[class^="udm"] ul li{'.$um['t'][0].'0 !important;}';
}
else
{
...
if($umdra)
{
$umr[$j++]='* html .udm li{'.$um['t'][10].'0;'.$um['t'][0].$um['items'][0].'px;}';
}
...
$umr[$j++]='ul[class^="udm"] li a{'.$um['t'][13].'0;}';
$umr[$j++]='ul[class^="udm"] li{'.$um['t'][13].$um['items'][0].'px;}';
$umr[$j++]='ul[class^="udm"] ul li{'.$um['t'][13].'0;}';
}
}
}
else
...
$umr[$j++]=$um['t'][18].'.udm/**/[class="udm"] li{position:'.$umps.';}}';
$umr[$j++]=$um['t'][18].'.udm/**/[class="udm"] ul li{'.$um['t'][19].'}}';
$umr[$j++]=$um['t'][2].'.udm li:not(:nth-child(n)),.udm ul li:not(:nth-child(n)){'.$um['t'][16].'}}';
...
$umr[$j++]='.udm ul{'.(eregi('(gif|png|mng|jpg|jpeg|jpe|bmp)',$um['menus'][7])?'background-image:url('.$um['baseSRC'].$um['menus'][7].');':'background-image:none;background-color:'.$um['menus'][7].';').$um['t'][15].'width:'.$um['menus'][5].';height:auto;'.$um['t'][5].$um['menus'][2].'px;'.$um['t'][6].$um['menus'][3].';'.$um['t'][7].$um['menus'][4].';'.$um['t'][12].'z-index:'.($um['orientation'][6]+19100).';padding:'.$um['menus'][6].'px;'.$um['menus'][8].'}';
...
$umr[$j++]=$um['t'][2].'* html .udm:not(:nth-child(n)) ul{'.$um['t'][9].$um['t'][14].'left:auto;top:auto;}}';
...
if($um['menus'][9]!='none')
{
$umr[$j++]='.udm .udmS{'.$um['t'][0].$um['menus'][10].';margin-top:'.($um['menus'][10]==0?0:str_replace('-','',$um['menus'][10])).';}';
$umr[$j++]='.udm .udmS{'.(eregi('(gif|png|mng|jpg|jpeg|jpe|bmp)',$um['menus'][9])?'background-image:url('.$um['baseSRC'].$um['menus'][9].');':'background-image:none;background-color:'.$um['menus'][9].';').$um['t'][15].$um['t'][12].'z-index:'.($um['orientation'][6]+19050).';'.$um['t'][28].'left:0px;top:0px;'.$um['t'][9].$um['menus'][11].'}';
if(ereg('filter\:progid\:DXImageTransform\.Microsoft\.Shadow',$um['menus'][11]))
{
$umr[$j++]=$um['t'][2].'* html .udm .udmS/**/ {'.$um['t'][33].'background:#ccc;'.$um['t'][8].$um['t'][3].'}}';
}
}
$umr[$j++]='.udm a,.udm a:link,.udm a.nohref{'.(eregi('(gif|png|mng|jpg|jpeg|jpe|bmp)',$um['items'][11])?'background-image:url('.$um['baseSRC'].$um['items'][11].');':'background-image:none;background-color:'.$um['items'][11].';').$um['t'][29].'z-index:'.$um['orientation'][6].';text-align:'.$umtxl.';'.$um['t'][7].$um['items'][4].';'.$um['t'][6].$um['items'][3].';'.$um['t'][4].$um['items'][9].'px;padding-right:'.$um['items'][9].'px;'.$um['t'][1].$um['items'][10].'px !important;padding-bottom:'.$um['items'][10].'px !important;'.$um['t'][11].$um['items'][17].';color:'.$um['items'][19].';'.$um['t'][5].$um['items'][1].'px;font-style:'.$um['items'][22].';font-family:'.$um['items'][15].';font-weight:'.$um['items'][16].' !important;}';
...
$umr[$j++]='.udm li a:visited{'.(eregi('(gif|png|mng|jpg|jpeg|jpe|bmp)',$um['items'][13])?'background-image:url('.$um['baseSRC'].$um['items'][13].');':'background-image:none;background-color:'.$um['items'][13].';').$um['t'][5].$um['items'][1].'px;color:'.$um['items'][21].';font-style:'.$um['items'][24].';'.$um['t'][7].$um['items'][8].';'.$um['t'][6].$um['items'][7].';'.$um['items'][27].'}';
$umr[$j++]='.udm li a.udmR,.udm li a.udmY,.udm li'.$um['t'][35].',.udm li'.$um['t'][37].',.udm li a:hover,.udm li a:focus,.udm li'.$um['t'][27].',.udm li'.$um['t'][26].'{font-style:'.$um['items'][23].';'.(eregi('(gif|png|mng|jpg|jpeg|jpe|bmp)',$um['items'][12])?'background-image:url('.$um['baseSRC'].$um['items'][12].');':'background-image:none;background-color:'.$um['items'][12].';').$um['t'][11].$um['items'][17].';color:'.$um['items'][20].';'.$um['t'][6].$um['items'][5].';'.$um['t'][7].$um['items'][6].';'.$um['t'][5].$um['items'][1].'px;'.$um['items'][26].'}';
$umr[$j++]='* html .udm li a:active{font-style:'.$um['items'][23].';'.(eregi('(gif|png|mng|jpg|jpeg|jpe|bmp)',$um['items'][12])?'background-image:url('.$um['baseSRC'].$um['items'][12].');':'background-image:none;background-color:'.$um['items'][12].';').$um['t'][11].$um['items'][17].';color:'.$um['items'][20].';'.$um['t'][6].$um['items'][5].';'.$um['t'][7].$um['items'][6].';'.$um['t'][5].$um['items'][1].'px;'.$um['items'][26].'}';
$umr[$j++]='.udm ul a,.udm ul a:link,.udm ul a.nohref{'.(eregi('(gif|png|mng|jpg|jpeg|jpe|bmp)',$um['menuItems'][11])?'background-image:url('.$um['baseSRC'].$um['menuItems'][11].');':'background-image:none;background-color:'.$um['menuItems'][11].';').'text-align:'.$um['menuItems'][18].';'.$um['t'][5].$um['menuItems'][1].'px;'.$um['t'][7].$um['menuItems'][4].';'.$um['t'][6].$um['menuItems'][3].';'.$um['t'][4].$um['menuItems'][9].'px;padding-right:'.$um['menuItems'][9].'px;'.$um['t'][1].$um['menuItems'][10].'px !important;padding-bottom:'.$um['menuItems'][10].'px !important;'.$um['t'][11].$um['menuItems'][17].';color:'.$um['menuItems'][19].';font-style:'.$um['menuItems'][22].';font-size:'.$um['menuItems'][14].';font-family:'.$um['menuItems'][15].';font-weight:'.$um['menuItems'][16].' !important;}';
...
$umr[$j++]='.udm ul li a:visited,'.$um['t'][20].'li a:visited{'.(eregi('(gif|png|mng|jpg|jpeg|jpe|bmp)',$um['menuItems'][13])?'background-image:url('.$um['baseSRC'].$um['menuItems'][13].');':'background-image:none;background-color:'.$um['menuItems'][13].';').'color:'.$um['menuItems'][21].';font-style:'.$um['menuItems'][24].';'.$um['t'][5].$um['menuItems'][1].'px;'.$um['t'][7].$um['menuItems'][8].';'.$um['t'][6].$um['menuItems'][7].';'.$um['menuItems'][27].'}';
$umr[$j++]='.udm ul li a.udmR,.udm ul li a.udmY,.udm ul li'.$um['t'][35].',.udm ul li'.$um['t'][37].',.udm ul li a:hover,.udm ul li a:focus,.udm ul li'.$um['t'][27].',.udm ul li'.$um['t'][26].',.udm ul li'.$um['t'][25].'{font-style:'.$um['menuItems'][23].';'.(eregi('(gif|png|mng|jpg|jpeg|jpe|bmp)',$um['menuItems'][12])?'background-image:url('.$um['baseSRC'].$um['menuItems'][12].');':'background-image:none;background-color:'.$um['menuItems'][12].';').$um['t'][11].$um['menuItems'][17].';color:'.$um['menuItems'][20].';'.$um['t'][6].$um['menuItems'][5].';'.$um['t'][7].$um['menuItems'][6].';'.$um['t'][5].$um['menuItems'][1].'px;'.$um['menuItems'][26].'}';
$umr[$j++]='* html .udm ul li a:active{font-style:'.$um['menuItems'][23].';'.(eregi('(gif|png|mng|jpg|jpeg|jpe|bmp)',$um['menuItems'][12])?'background-image:url('.$um['baseSRC'].$um['menuItems'][12].');':'background-image:none;background-color:'.$um['menuItems'][12].';').$um['t'][11].$um['menuItems'][17].';color:'.$um['menuItems'][20].';'.$um['t'][6].$um['menuItems'][5].';'.$um['t'][7].$um['menuItems'][6].';'.$um['t'][5].$um['menuItems'][1].'px;'.$um['menuItems'][26].'}';
$umr[$j++]='.udm a.nohref,.udm ul a.nohref{cursor:default !important;}';
$umr[$j++]='.udm h1,.udm h2,.udm h3,.udm h4,.udm h5,.udm h6{display:block;background:none;margin:0;padding:0;border:none;font-size:1em;font-weight:normal;text-decoration:none;}';
if($um['orientation'][0]=='horizontal')
{
...
$umr[$j++]=$um['t'][2].'.udm h3,.udm h4,.udm h5,.udm h6{width:expression("auto",this.runtimeStyle.width=this.parentNode.offsetWidth);width/**/:auto;}}';
$umr[$j++]=$um['t'][2].'.udm ul h3,.udm ul h4,.udm ul h5,.udm ul h6{width:expression("auto",this.runtimeStyle.width=this.parentNode.currentStyle.width);width/**/:auto;}}';
}
else
{
...
$umr[$j++]=$um['t'][2].$um['t'][31].' li,'.$um['t'][31].' ul li{display:block;float:'.$umfloats.';}}';
...
{
$umr[$j++]='.udm ul.'.$umk.'{width:'.$umv[2].';'.$um['t'][6].$umv[0].';'.$um['t'][7].$umv[1].';'.(eregi('(gif|png|mng|jpg|jpeg|jpe|bmp)',$umv[3])?'background-image:url('.$um['baseSRC'].$umv[3].');':'background-image:none;background-color:'.$umv[3].';').$umv[4].'}';
$umr[$j++]='.udm span.'.$umk.'{'.$um['t'][0].$umv[6].';margin-top:'.str_replace('-','',$umv[6]).';}';
if(ereg('filter\:progid\:DXImageTransform\.Microsoft\.Shadow',$umv[7]))
{
$umr[$j++]=$um['t'][2].'* html .udm span.'.$umk.'/**/ {'.$um['t'][8].$um['t'][3].'}}';
}
if($umv[5]!='none'){$umr[$j++]='.udm span.'.$umk.'{'.(eregi('(gif|png|mng|jpg|jpeg|jpe|bmp)',$umv[5])?'background-image:url('.$um['baseSRC'].$umv[5].');':'background-image:none;background-color:'.$umv[5].';').'filter:none;'.$umv[7].'}';}
}
}
...
{
$umbg=(eregi('(gif|png|mng|jpg|jpeg|jpe|bmp)',$umv[6])?'background-image:url('.$um['baseSRC'].$umv[6].');':'background-image:none;background-color:'.$umv[6].';');
...
$umr[$j++]='.udm ul li.'.$umk.' a:visited,'.$um['t'][20].'li.'.$umk.' a:visited{'.(eregi('(gif|png|mng|jpg|jpeg|jpe|bmp)',$umv[8])?'background-image:url('.$um['baseSRC'].$umv[8].');':'background-image:none;background-color:'.$umv[8].';').'color:'.$umv[16].';font-style:'.$umv[19].';'.$um['t'][5].$um['menuItems'][1].'px;'.$um['t'][6].$umv[4].';'.$um['t'][7].$umv[5].';'.$umv[22].'}';
$umr[$j++]='.udm ul li.'.$umk.' a.udmR,.udm ul li.'.$umk.' a.udmY,.udm ul li.'.$umk.$um['t'][35].',.udm ul li.'.$umk.$um['t'][37].',.udm ul li.'.$umk.' a:hover,.udm ul li.'.$umk.' a:focus,.udm ul li.'.$umk.$um['t'][27].',.udm ul li.'.$umk.$um['t'][26].',.udm ul li.'.$umk.$um['t'][25].'{'.(eregi('(gif|png|mng|jpg|jpeg|jpe|bmp)',$umv[7])?'background-image:url('.$um['baseSRC'].$umv[7].');':'background-image:none;background-color:'.$umv[7].';').$um['t'][11].$umv[12].';color:'.$umv[15].';'.$um['t'][5].$um['menuItems'][1].'px;'.$um['t'][6].$umv[2].';'.$um['t'][7].$umv[3].';font-style:'.$umv[18].';'.$umv[21].'}';
$umr[$j++]='* html .udm li.'.$umk.' a:active{'.(eregi('(gif|png|mng|jpg|jpeg|jpe|bmp)',$umv[7])?'background-image:url('.$um['baseSRC'].$umv[7].');':'background-image:none;background-color:'.$umv[7].';').$um['t'][11].$umv[12].';color:'.$umv[15].';'.$um['t'][5].$um['menuItems'][1].'px;'.$um['t'][6].$umv[2].';'.$um['t'][7].$umv[3].';font-style:'.$umv[18].';'.$umv[21].'}';
}
}
